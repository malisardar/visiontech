...
<section class="HomeHeader CreativeDesignHeader">
	<div class="headerimagezoom uk-visible@m" style="background-image: url(images/Banners/banner_design.jpg);"></div>
	<div class="headerimagezoom uk-hidden@m" style="background-image: url(images/Banners/banner_design.jpg);"></div>
	...
	<div class="mdl">
		<div class="mdl_inner">
			<div class="uk-container ContainerCustom opacitytoggle">
				<p uk-scrollspy="cls:uk-animation-fade; delay: 500">Banner Design</p>
				<h1 class="heading" uk-scrollspy="cls:uk-animation-fade; delay: 1000">
					Banners That Speak <br> Before You Stream
				</h1>
				<div class="" uk-grid="">
...
<div class="FadeContainer" uk-scrollspy="cls: uk-animation-fade; target: .AnimFade; delay: 250">
	<div class="AboutPage CreativeDesignPage" uk-scrollspy="cls: uk-animation-slide-bottom-medium; target: .AnimSlide; delay: 250">
		...
		<section class="TechCompanySec uk-text-center">
			<div class="uk-container ContainerCustom">
				<h6 class="sec1heading AnimFade">Make Your Channel Stand Out with Custom Banners</h6>
			
				<div class="toggleBtnBox">
					<button class="toggleBtn"><img src="images/explorermore.svg" uk-svg="" /></button>
				</div>
				<div class="toggleBox">
					<div class="pmdm"><p>We create static and animated banner designs that make your channel look professional. Our banners include social media headers, stream banners, and promotional graphics that highlight your vibes. </p></div>
		...
		<section class="AboutGameChangeSec uk-text-center">
			<div class="uk-container ContainerCustom">
				...
				<div class="AboutGameChangeBox">
					<h2 class="AnimFade">Why should streamers work with us</h2>
					<p class="AnimFade">
We focus on high-quality, professional designs. Our banners complement your individual gaming style and make your channel stand out.
</p>
			<p class="AnimFade">
We help streamers and gamers look super sharp on all their platforms. Our banners are created to attract viewers, showcase your vibe, and get people interacting more.
</p>
				...
				<div class="uk-flex-center" uk-grid="">
					...
					<div class="uk-width-1-5@m uk-width-1-3@s uk-width-1-2@s">
						<div class="OfferServicesBox AnimSlide">
							...
							<div class="OfferServicestxt">
								<h3>Stream Offline / Starting / Ending Banners</h3>
							</div>
						</div>
					</div>
						<div class="uk-width-1-5@m uk-width-1-3@s uk-width-1-2@s">
