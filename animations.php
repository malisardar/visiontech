	...
	<div class="mdl">
		<div class="mdl_inner">
			<div class="uk-container ContainerCustom opacitytoggle">
				<p uk-scrollspy="cls:uk-animation-fade; delay: 500">Animation</p>
				<h1 class="heading" uk-scrollspy="cls:uk-animation-fade; delay: 1000">
					Bring characters, brands, <br> and concepts <br> alive with motion
				</h1>
				<div class="" uk-grid="">
...
<div class="FadeContainer" uk-scrollspy="cls: uk-animation-fade; target: .AnimFade; delay: 250">
	<div class="AboutPage CreativeDesignPage" uk-scrollspy="cls: uk-animation-slide-bottom-medium; target: .AnimSlide; delay: 250">
		...
		<section class="TechCompanySec uk-text-center">
			<div class="uk-container ContainerCustom">
				<h6 class="sec1heading AnimFade">Animations That Bring Stories comes Alive</h6>
			
				<div class="toggleBtnBox">
					<button class="toggleBtn"><img src="images/explorermore.svg" uk-svg="" /></button>
				</div>
				<div class="toggleBox">
	<div class="pmdm"><p>We create animations that fit your brand or channel theme. This can be 2D and 3D animations, cartoon characters themselves, VTuber avatars, and explainer videos that are designed to capture attention and convey your message in an understandable manner.</p></div>
	<div class="pmdm"><p>We help, creators, gamers, brands and businesses make their identities with animations that stand out. From short explainer videos to full-scale animated campaigns, our designs make your content look professional, lively, and memorable.</p></div>
		...
		<section class="AboutGameChangeSec uk-text-center">
			<div class="uk-container ContainerCustom">
				...
				<div class="AboutGameChangeBox">
					...
					<p class="AnimFade">We create animations that do more than look good—they tell stories, educate, and entertain. Every design is customized according to your requirements, Offering a professional, distinctive, and unified visual identity.</p>
