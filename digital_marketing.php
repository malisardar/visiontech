	...
	<div class="mdl">
		<div class="mdl_inner">
			<div class="uk-container ContainerCustom opacitytoggle">
				<p uk-scrollspy="cls:uk-animation-fade; delay: 500">Digital Marketing</p>
...
<div class="FadeContainer" uk-scrollspy="cls: uk-animation-fade; target: .AnimFade; delay: 250">
	<div class="AboutPage CreativeDesignPage" uk-scrollspy="cls: uk-animation-slide-bottom-medium; target: .AnimSlide; delay: 250">
		...
		<section class="TechCompanySec uk-text-center">
			<div class="uk-container ContainerCustom">
				<h6 class="sec1heading AnimFade">Strategies that Converts, Engages & Get Sales</h6>
				<h2 class="sec2heading AnimFade">All in One Solutions for Businesses and Brands</h2>
				<div class="toggleBtnBox">
					<button class="toggleBtn"><img src="images/explorermore.svg" uk-svg="" /></button>
				</div>
				<div class="toggleBox">
					<div class="pmdm"><p>We provide full-service digital marketing designed to your business goals. We have expertise in SEO, social media marketing, PPC, email marketing, and content strategy. From education, retail, IT, corporate, and beyond, our campaigns get your brand in front of the right audiences and deliver actual results. </p></div>
		...
		<section class="AboutGameChangeSec uk-text-center">
			<div class="uk-container ContainerCustom">
				...
				<div class="AboutGameChangeBox">
					<h2 class="AnimFade">The Impact of Smart Digital Marketing</h2>
					<p class="AnimFade">We assist businesses increased their visibility, attract leads, and get conversions. Every strategy is designed to connect with your target audience and deliver tangible growth.</p>
